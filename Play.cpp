...
void About()
{
	...
	cout << "-> Pham Minh Tuan - CNTT - 6251071111." << endl;
	_Common::gotoXY(50, 23);
	cout << "-> Nguyen Vi Hoa Binh - CNTT - 6251071011." << endl;
...
void ScreenStartGame(int n)
{
	...
	Textcolor(7);
	_Common::gotoXY(50, 21); cout << "Load Game";
	_Common::gotoXY(50, 22); cout << "Help";
	_Common::gotoXY(50, 23); cout << "About";
	_Common::gotoXY(50, 24); cout << "Exit";
